...
You can either interact with Quarto files within VSCode or "render" them into finished documents. To create a finished document, click the "Render" button in VSCode. 
...
When you execute code within VSCode, the code runs in the terminal. If there is visual output, then it will appear in a pane to the left. 
